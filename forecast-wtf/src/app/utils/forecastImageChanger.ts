const weatherImageMap = [
    ...
    {
        codes: [1000, 1003],
        dayImage: "/desktop/sun.jpg",
        nightImage: "/desktop/night.jpg"
    },
    // Cloudy & Overcast
    {
        codes: [1006, 1009],
        image: "/desktop/cloudy.jpg"
    },
    // Rain
    {
        codes: [
        ...
        image: "/desktop/rain.jpg"
    },
    // Thunderstorms
    {
        codes: [1087, 1273, 1276, 1279, 1282],
        image: "/desktop/thunder.jpg"
    },
    // Snow/Ice
    {
        codes: [
...
export const ForecastImageChanger = (code: number, isDay: number): string => {
    for (const group of weatherImageMap) {
        if (group.codes.includes(code)) {
            if (isDay == 1 && 'dayImage' in group) {
                return group.dayImage;
            }
            if (isDay == 0  && 'nightImage' in group) {
                return group.nightImage;
            }
            return group.image || '/desktop/night.jpg';
        }
    }
